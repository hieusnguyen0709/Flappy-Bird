...
while running:
	...
	tube1_image=pygame.transform.scale(tube_img,(tube_width,tube1_height))
	tube1=screen.blit(tube1_image,(tube1_x,0))
	tube2_image=pygame.transform.scale(tube_img,(tube_width,tube2_height))
	tube2=screen.blit(tube2_image,(tube2_x,0))
	tube3_image=pygame.transform.scale(tube_img,(tube_width,tube3_height))
	tube3=screen.blit(tube3_image,(tube3_x,0))
	#Ép ảnh ổng và vẽ ống đối diện
